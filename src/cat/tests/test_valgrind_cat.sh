...
testing()
{
    ...
    valgrind --log-file="tests/valgrind_s21_cat.log" --trace-children=yes --track-fds=yes --track-origins=yes --leak-check=full --show-leak-kinds=all ./test $t > tests/test_s21_cat.log
    ...
    rm tests/test_s21_cat.log
    rm tests/valgrind_s21_cat.log
}
